...
const input='w-full rounded-2xl border border-[#d6e1d9] bg-white px-4 py-3.5 text-[16px] text-[#18312b] shadow-[0_1px_2px_rgba(22,54,42,.03)] outline-none transition focus:border-[#4f977d] focus:ring-4 focus:ring-[#dcece3]';
